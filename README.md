...
This application just uses facebook.com, running on EdgeWebView2 based on the v1.0 base code of [Edgescape Navigator](https://github.com/thedoggybrad/edgescape_navigator).
<br>
